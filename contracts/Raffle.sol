...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
     ...
     *  - Look to "upkeepNeeded" to return true
     *
     * To return true
    ...
    function fulfillRandomWords(
        ...
        uint256 indexOfWinner = randomWords[0] % s_players.length; // <- Since NUM_WORDS = 1, randomWords array only has one element
    ...
    // Constant variables not in storage, therefore can use pure .
